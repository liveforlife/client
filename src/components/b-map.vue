<template>
 <div class="map">
  <!--container-->
  <div id="r-result">
   <div>搜索提示：<input type="text" id="suggestId" value="" placeholder="请输入地址" /><br/></div>
   <div>
    通讯地址：<input type="text" class="address" v-model="address_detail" :disabled="isFlag?false:true"></input>
  ...
  methods: {
   ...
   ready: function () {
    ...
    if(this.position.lng !== '' && this.position.lat !== ''){
		var point = new BMap.Point(this.position.lng,this.position.lat);
